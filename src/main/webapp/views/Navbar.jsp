            ...
            <span class="right">
                <li class="nav-item">
                    <a href="blog" class="nav-link">
                        <!-- Scroll duotone icon -->
                        <svg aria-hidden="true" focusable="false" data-prefix="fad" data-icon="scroll-old" role="img"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"
                            class="svg-inline--fa fa-scroll-old fa-w-20 fa-7x">
                            <g class="fa-group">
                                <path fill="currentColor"
                                    d="M539.31 228.69L512 256l27.31 27.31a16 16 0 0 1 4.69 11.32V384h-89.37a16 16 0 0 0-11.32 4.69L416 416l-27.31-27.31a16 16 0 0 0-11.32-4.69H304a16 16 0 0 0-16 16v32a80 80 0 0 1-80.61 80c-44.11-.33-79.39-36.89-79.39-81V262.63a16 16 0 0 1 4.69-11.32L160 224l-27.31-27.31a16 16 0 0 1-4.69-11.32V65A65 65 0 0 0 63 0h385a96.1 96.1 0 0 1 95.68 88.2 16.15 16.15 0 0 1-4.63 12.8L512 128l27.31 27.31a16 16 0 0 1 4.69 11.32v50.74a16 16 0 0 1-4.69 11.32z"
                                ...
                                <path fill="currentColor"
                                    ...
                                    opacity="0.4" class="fa-primary"></path>
                            </g>
                        </svg>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="loan" class="nav-link">
                        <!-- Hand shake duotone icon -->
                        <svg aria-hidden="true" focusable="false" data-prefix="fad" data-icon="hands-helping"
                            class="svg-inline--fa fa-hands-helping fa-w-20" role="img"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                            <g class="fa-group">
                                <path class="fa-secondary" fill="currentColor"
                                    d="M224 248V121.68a31.78 31.78 0 0 1 15-27.1l33.5-20.9A64.48 64.48 0 0 1 306.4 64h102.21L512 4.28A32 32 0 0 1 555.72 16l80 138.6a32 32 0 0 1-11.7 43.7l-80 46.2V216a56 56 0 0 0-56-56H304v88a40 40 0 1 1-80 0z"
                                    opacity="0.4"></path>
                                <path class="fa-primary" fill="currentColor"
                                    d="M4.32 357.38A31.92 31.92 0 0 1 16 313.68l80-46.2v-47.3a63.86 63.86 0 0 1 31.1-54.8l64.89-39V248a72 72 0 1 0 144 0v-56H488a23.94 23.94 0 0 1 24 24v48a23.94 23.94 0 0 1-24 24h-8v64a32 32 0 0 1-32 32h-16a64.06 64.06 0 0 1-64 64H231.41L128 507.68A32 32 0 0 1 84.32 496z">
                                </path>
                            </g>
                        </svg>
                    </a>
                ...
                <li class="nav-item">
                    <a href="sign-up" class="nav-link">
                        <!-- Astronaut duotone icon -->
                        <svg aria-hidden="true" focusable="false" data-prefix="fad" data-icon="user-astronaut"
                            class="svg-inline--fa fa-user-astronaut fa-w-14" role="img"
